...
public class LinksDataParser {
    ...
    public static String parseInfo(ShowListResponseDTO showListResponseDTO) {
        ...
        for (int i = 0; i < showListResponseDTO.links.size(); i++) {
            answer.append("Ссылка: ")
                    .append(showListResponseDTO.links.get(i).url())
                    .append("\n");
            answer.append("Теги: ")
                    .append(showListResponseDTO.links.get(i).tags())
                    .append("\n");
            answer.append("Фильтры: ")
                    .append(showListResponseDTO.links.get(i).filters())
                    .append("\n");
            answer.append("\n");
        }
